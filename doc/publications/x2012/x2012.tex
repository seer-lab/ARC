...
sliding window is used to prevent domination of the weighting. The weighting is
designed to ensure that the change of selecting an operator is always greater
than zero regardless of performance.. To ensure that this approach is up to
date the current weighting for each operator is recalculated based on the new
...
made.  During the initialization of phase 2 the proposed fix is run a large
