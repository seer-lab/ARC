...
%In one execution a concurrency bug might occur, then a second, third and forth it does not. 
...
$\times$ \# runs $times$ ConTest run time) times alone can take significant 
...
Each program was run through ARC a total of \textbf{X} times using the parameters
...
same kind of evolutionary strategy attempts to opimize the program by
